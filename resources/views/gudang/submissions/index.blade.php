                ...
                <ul class="nav nav-pills" id="status-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $currentStatus == 'pending' ? 'active' : '' }}" 
                           href="{{ route('gudang.submissions.index', ['status' => 'pending']) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $currentStatus == 'approved' ? 'active' : '' }}" 
                           href="{{ route('gudang.submissions.index', ['status' => 'approved']) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $currentStatus == 'rejected' ? 'active' : '' }}" 
                           href="{{ route('gudang.submissions.index', ['status' => 'rejected']) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $currentStatus == 'all' ? 'active' : '' }}" 
                           href="{{ route('gudang.submissions.index', ['status' => 'all']) }}">
                ...
                @else
                    ...
                    <div class="text-center py-5">
                        ...
                        @if($currentStatus !== 'all')
                            <a href="{{ route('gudang.submissions.index', ['status' => 'all']) }}" 
