        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('gudang.submissions.index') }}">Verifikasi Barang</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('gudang.submissions.approve', $submission) }}" class="d-inline">
                    @csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="{{ route('gudang.submissions.reject', $submission) }}">
                @csrf
                <div class="modal-header">
