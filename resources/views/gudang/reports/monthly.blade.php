                        ...
                        <table class="table table-sm table-hover table-bordered">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th width="13%" class="text-center">Waktu</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($reportData['transactions'] as $index => $transaction)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <small class="text-muted">Penerimaan barang dari {{ $transaction->supplier->name ?? '-' }}</small>
                                            @endif
                                        </td>
                                        <td class="text-center">
                        ...
                        <table class="table table-sm table-hover table-bordered">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th width="17%" class="text-end">Harga Total</th>
                                </tr>
                            </thead>
                            <tbody>
...
<!-- Current Stock Status - Removed old table -->
