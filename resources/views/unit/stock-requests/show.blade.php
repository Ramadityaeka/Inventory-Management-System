...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('unit.stock-requests.index') }}" class="btn btn-secondary">
        ...
        <div class="card">
            ...
            @if($stockRequest->status === 'pending')
                <div class="card-footer bg-light">
                    <div class="row g-2">
                        <div class="col-md-6">
                            <form action="{{ route('unit.stock-requests.approve', $stockRequest) }}" 
                                  method="POST"
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('unit.stock-requests.reject', $stockRequest) }}" method="POST">
                @csrf
