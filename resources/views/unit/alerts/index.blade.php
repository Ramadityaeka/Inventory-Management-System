...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('unit.alerts') }}" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-end gap-2">
                ...
                <a href="{{ route('unit.alerts') }}" class="btn btn-outline-secondary">
                ...
                @foreach($alerts as $alert)
                    <div class="list-group-item {{ !$alert->is_read ? 'bg-light' : '' }}">
                        <div class="d-flex w-100 justify-content-between align-items-start">
                            ...
                            <div class="ms-3">
                                @if(!$alert->is_read)
                                    <form action="{{ route('unit.alerts.markAsRead', $alert->id) }}" method="POST">
                                        @csrf
