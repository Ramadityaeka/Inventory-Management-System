...
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('unit.stocks.index') }}" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('unit.stocks.index') }}" class="btn btn-secondary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('unit.stocks.history', $stock->item) }}" 
...
<div class="modal fade" id="adjustmentModal" tabindex="-1" aria-labelledby="adjustmentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="adjustmentForm" method="POST" action="{{ route('unit.stocks.adjust') }}">
                @csrf
