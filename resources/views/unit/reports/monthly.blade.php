...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('unit.reports.monthly.generate') }}" class="row g-3">
            @csrf
            <div class="col-md-4">
    ...
    <div class="col-md-3">
        <div class="card border-success">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0 small">Total Stok Masuk</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-danger">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0 small">Total Stok Keluar</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-lg-8 mb-4">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted">{{ $reportData['item_movements']->count() }} barang dengan aktivitas</small>
            </div>
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if($movement['current_stock'] <= 0)
                                                <small class="text-danger"><i class="bi bi-exclamation-triangle"></i> Stok Habis</small>
                                            @else
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <div class="alert alert-info mb-0">
                    ...
                    <strong>{{ $reportData['current_stocks']->count() }}</strong> Total Barang
                </div>
            </div>
            <div class="col-md-4">
...
<div class="card">
    <div class="card-body text-center">
        <form method="POST" action="{{ route('unit.reports.monthly.exportPdf') }}" class="d-inline">
            @csrf
