...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.reports.stock-summary') }}" id="filterForm">
                <div class="row g-3">
                    <!-- Category Filter -->
                    <div class="col-md-3">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <a href="{{ route('admin.reports.stock-summary') }}" class="btn btn-secondary">
...
function exportPdf() {
    ...
    const url = "{{ route('admin.reports.stock-summary.pdf') }}" + '?' + params.toString();
...
function exportExcel() {
    ...
    const params = new URLSearchParams(window.location.search);
    const url = "{{ route('admin.reports.stock-summary.excel') }}" + '?' + params.toString();
